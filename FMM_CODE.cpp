...
int main(){
    ...
    FMM::XorBinaryFuseFilter<size_t,size_t> test(datasize,category_num,fingerprint_length);
    cout<<"Bit length: "<<test.get_bit_all()<<endl;
    ...
    cout<<"Theoretic false positive:"<<pow(2,-1*fingerprint_length)<<endl;
